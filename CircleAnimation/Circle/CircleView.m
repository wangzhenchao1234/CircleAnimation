...
-(void)addCircle{
    ...
    [animationPath addArcWithCenter:CGPointMake(self.frame.size.width*0.5, self.frame.size.height * 0.5) radius:self.frame.size.width * 0.5 - 7.5 startAngle:DEGREES_DefaultStart(0) endAngle:DEGREES_DefaultStart(360) clockwise:YES];
    ...
    if(!self.animtionLayer){
        ...
        self.animtionLayer.lineWidth = 17;
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    //真正的弧形路径
    UIBezierPath *animationPath = [UIBezierPath bezierPath];
    [animationPath addArcWithCenter:CGPointMake(self.frame.size.width*0.5, self.frame.size.height * 0.5) radius:self.frame.size.width * 0.5 - 7.5 startAngle:DEGREES_DefaultStart(0) endAngle:self.endDegree clockwise:YES];
